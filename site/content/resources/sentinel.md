...
- **Case management** — structured case files linking subjects, entities, sources, and assessments
- **Subject profiling** — Person of Interest and Organisation of Interest profiles built from documented OSINT collection
- **Breach data integration** — structured search and correlation against breach datasets for investigative context
- **Intelligence products** — templated output generation for finished assessments tied to the case record
- **Audit trail** — full collection provenance for legal and organisational accountability
